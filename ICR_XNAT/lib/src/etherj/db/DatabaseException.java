 ...
 * @author adminjamesd
 */
public class DatabaseException extends Exception implements Displayable
{
	...
	/**
	 * Constructs an instance of
	 * <code>DatabaseException</code> with the specified detail message and
	 * cause.
	 *
	 * @param msg the detail message.
	...
	/**
	 * Constructs an instance of
	 * <code>DatabaseException</code> with the specified cause.
	 *
	 * @param cause the cause.
	 */
