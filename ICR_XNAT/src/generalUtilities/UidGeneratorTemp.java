 ...
 *
 * Java class: UidGeneratorTemp.java
 * 
 * Main use is to create new UidGeneratorTemp's for Java objects that are generated.
 *
...
public class UidGeneratorTemp
{
   ...
   // UidGeneratorTemp type ID list - will be extended over time.
    ...
    * described in Kamauu et al. J Digit Imaging. 2009 February; 22(1): 11–14. 
    * @return a String containing the UidGeneratorTemp
    */
                                  ...
                                  int UIDTypeID)
   {
       ...
       *                         as generated by java.rmi.server.UidGeneratorTemp and
      ...
      // carry on without proper UidGeneratorTemp's.
